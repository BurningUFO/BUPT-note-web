<div class="home-hero reveal-on-scroll">
...
<div class="quickstart reveal-on-scroll">
  <div class="quickstart-item">
    <p class="qs-title">定位目标</p>
    <p>先从一个目录进入，按主题持续记录而不是零散存放。</p>
  </div>
  <div class="quickstart-item">
    <p class="qs-title">记录模板</p>
    <p>每篇笔记建议包含：定义、示例、易错点、练习题链接。</p>
  </div>
  <div class="quickstart-item">
    <p class="qs-title">周期复盘</p>
    <p>每周回看新增内容，补充索引和跨主题关联。</p>
  </div>
</div>
...
<div class="feature-grid">
  <div class="feature-card reveal-on-scroll">
    <h3>结构清晰</h3>
    <p>一级目录直接映射学习主线，降低查找成本。</p>
  </div>
  <div class="feature-card reveal-on-scroll">
    <h3>代码友好</h3>
    <p>高亮、复制、行号锚点齐全，适合算法与工程笔记。</p>
  </div>
  <div class="feature-card reveal-on-scroll">
    <h3>跨端一致</h3>
    <p>桌面与移动端保持统一视觉和阅读节奏。</p>
  </div>
  <div class="feature-card reveal-on-scroll">
    <h3>轻量动效</h3>
    <p>滚动渐显和交互反馈克制自然，不影响阅读。</p>
  </div>
</div>
...
<div class="faq-list reveal-on-scroll">
  <details>
    <summary>这个网站适合怎么维护？</summary>
    <p>按周增量更新，保持目录稳定，避免频繁改名导致链接失效。</p>
  </details>
  <details>
    <summary>如何提升笔记可读性？</summary>
    <p>每节先给结论，再放例子，最后补边界条件和复杂度分析。</p>
  </details>
  <details>
    <summary>作者是谁？</summary>
    <p>本站作者署名为 <strong>BurningUFO</strong>。</p>
  </details>
</div>
